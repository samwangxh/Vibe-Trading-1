...
import { Activity, BarChart3, Bot, Languages, Moon, Sun, Plus, Trash2, Pencil, MessageSquare, ChevronsLeft, ChevronsRight, Settings, Layers, Loader2, LayoutDashboard, Cpu } from "lucide-react";
...
export function Layout() {
  ...
  const NAV = [
    ...
    { to: "/humanoid-robot", icon: Cpu, label: t('layout.humanoidRobot') },
